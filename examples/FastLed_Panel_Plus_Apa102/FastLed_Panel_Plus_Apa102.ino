...
uint16_t getPixelFromXYCallback(int16_t x, int16_t y) {
  ...
  // Testing: this changes the order of the LEDs, but it's not really working now that we use setSerpentineLayout(false), replace this with code generated by the Apa102Mapping Example
}
#endif
