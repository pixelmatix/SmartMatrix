...
#pragma message "MatrixHardware: SmartLED Shield for Teensy 4 V0 with GBR color channels"
...
#define R_0_SIGNAL    FLEXIO_PIN_G0_TEENSY_PIN
#define G_0_SIGNAL    FLEXIO_PIN_B0_TEENSY_PIN
#define B_0_SIGNAL    FLEXIO_PIN_R0_TEENSY_PIN
#define R_1_SIGNAL    FLEXIO_PIN_G1_TEENSY_PIN
