...
<text x="236.22" y="7.62" size="3.048" layer="94">V5</text>
...
kickback when switching long strings of LEDs on and off using USB power</text>
...
Default: R1 47k, R2 DNP, J1 open
LED_EN pin free, LEDs will always be driven

Alt: R1 DNP, R2 47k, J1 short
...
Default: JP2 connects 4 to APA_CLK
JP3 connects 5 to APA_DAT.
Can drive APA102 LEDs from FlexIO periperal, and drive HUB75 panel at same time

Alt: JP2 connects 13 "SPI(4) SCK" and APA_CLK (Pin 4 free),
JP3 connects 11 "SPI(4) MOSI" and APA_DAT (Pin 5 free).
Must choose between driving HUB75 panel *OR* APA102 LEDs</text>
...
<text x="5.08" y="129.54" size="1.778" layer="94">Default: Teensy pin 7 to BUFFER_CLK, Audio Shield DIN (to Teensy) free, DOUT (to Shield) blocked
Alt:  Teensy pin 8 to BUFFER_CLK, Audio Shield DOUT (to Shield) free, DIN (to Teensy) blocked</text>
</plain>
<instances>
...
<attribute name="VALUE" x="32.258" y="47.752" size="1.778" layer="96" rot="R270"/>
</instance>
...
<instance part="JP3" gate="G$1" x="27.94" y="73.66" smashed="yes" rot="R180">
<attribute name="NAME" x="25.654" y="74.295" size="1.778" layer="95" font="vector" rot="R180"/>
</instance>
<instance part="JP2" gate="G$1" x="27.94" y="58.42" smashed="yes" rot="R180">
<attribute name="NAME" x="25.654" y="59.055" size="1.778" layer="95" font="vector" rot="R180"/>
</instance>
<instance part="JP4" gate="G$1" x="25.4" y="152.4" smashed="yes" rot="MR90">
<attribute name="NAME" x="22.352" y="152.781" size="1.778" layer="95" font="vector" rot="MR0"/>
</instance>
<instance part="JP1" gate="G$1" x="27.94" y="40.64" smashed="yes">
<attribute name="NAME" x="25.4" y="35.56" size="1.778" layer="95" font="vector"/>
</instance>
</instances>
<busses>
</busses>
